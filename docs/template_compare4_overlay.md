...
- Toolbar (flex, wrappable):
  - View toggle segment: `Split Map View` → `/compare4/view/{rids}` | `Overlay Map View` (active)
  - Track visibility toggle buttons (per file: color badge + filename)
